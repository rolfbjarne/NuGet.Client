...
@"<package xmlns='http://schemas.microsoft.com/packaging/2013/05/nuspec.xsd'>
  ...
  <group targetFramework="".NETCoreApp3.0"">
    ...
    <dependency id=""packageB"" version=""1.0.0"" />
        ...
        [InlineData(".x", NuGetLogCode.NU5501)]
        [InlineData(".jpeg.x", NuGetLogCode.NU5501)]
        [InlineData("", NuGetLogCode.NU5501)]
        public void PackCommand_PackIcon_InvalidExtension_Succeeds_WarnsIfInvalid(string fileExtension, NuGetLogCode? logCode)
        {
            NuspecBuilder nuspecBuilder = NuspecBuilder.Create();
            TestDirectoryBuilder testDirBuilder = TestDirectoryBuilder.Create();
            var rng = new Random();
            ...
            TestPackIconSuccess(testDirBuilder, iconFile, logCode?.ToString());
        }
